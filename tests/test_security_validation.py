...
class TestSecurityValidator:
    ...
    def test_company_name_validation_valid(self):
        ...
        for name in valid_names:
            ...
            ), f"Company name {name} should be trimmed"
    ...
    def test_company_name_validation_injection_attempts(self):
        ...
        for name in injection_attempts:
            ...
            assert (
                ...
                or "forbidden characters" in error.lower()
            ), f"Should detect injection in {name}: {error}"
    ...
    def test_search_query_validation_injection_attempts(self):
        ...
        for query in injection_attempts:
            ...
            assert (
                ...
                or "invalid characters" in error.lower()
                or "forbidden characters" in error.lower()
            ), f"Should detect injection in {query}: {error}"
    ...
    def test_numeric_validation_invalid(self):
        ...
        invalid_numbers = ["abc", "12.34.56", "12a34", "", "12-34-56", "12.34.56.78"]
    ...
    def test_prompt_sanitization(self):
        ...
        for prompt in malicious_prompts:
            ...
            assert (
                "ignore previous" not in sanitized.lower()
    ...
    def test_api_response_validation(self):
        ...
        for response in valid_responses:
            ...
            assert sanitized is not None, "Sanitized response should not be None"
...
class TestEdgeCases:
    ...
    def test_maximum_length_inputs(self):
        ...
        assert (
            ...
            or "does not match required pattern" in error.lower()
        )
