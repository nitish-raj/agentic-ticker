...
def sample_indicator_data():
    ...
    return [
        {'date': '2023-01-03', 'ma5': 101.0, 'ma10': 100.5, 'daily_return': 0.01, 'volatility': 0.02},
        {'date': '2023-01-04', 'ma5': 102.0, 'ma10': 101.0, 'daily_return': 0.02, 'volatility': 0.02},
        {'date': '2023-01-05', 'ma5': 103.0, 'ma10': 101.5, 'daily_return': 0.01, 'volatility': 0.02},
    ]
...
def sample_events():
    ...
    return [
        {'date': '2023-01-04', 'price': 102.0, 'change_percent': 5.0, 'direction': 'UP'},
        {'date': '2023-01-05', 'price': 103.0, 'change_percent': -3.0, 'direction': 'DOWN'},
    ]
...
def sample_forecasts():
    ...
    return [
        {'date': '2023-01-06', 'forecast_price': 104.0, 'confidence': 0.8, 'trend': 'UP'},
        {'date': '2023-01-07', 'forecast_price': 105.0, 'confidence': 0.7, 'trend': 'UP'},
    ]
